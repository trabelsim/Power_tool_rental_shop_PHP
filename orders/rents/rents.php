...
<body>
    ...
    <div style="text-align:left;">
        <a style="text-align:center; margin-left:200px; margin-bottom:50px;" class="btn btn-primary" href="http://localhost/projekt/orders/orders.php" role="button">Wszystkie</a>
        <a style="text-align:center; margin-left:50px; margin-bottom:50px;" class="btn btn-primary" href="http://localhost/projekt/orders/reservations/reservations.php" role="button">Rezerwacje</a>
        <a style="text-align:center; margin-left:50px; margin-bottom:50px;" class="btn btn-primary" href="http://localhost/projekt/orders/rents/rents.php" role="button">Wypożyczenia</a>
            ...
            <thead class="thead-dark">
                ...
                <?php
                    while($element = $statement->fetch()){
                        ...
                        echo "<td style='text-align:center;'>".$element['element_cost'].'</td>';
                        // zamówienie start
                        if($element['status'] == 0){
