...
<body>
    ...
    <a style="text-align:center; margin-left:50px;" class="btn btn-primary" href="http://localhost/projekt/index.php" role="button">Strona główna</a>
    <a style="text-align:center; margin-left:50px;" class="btn btn-primary" href="http://localhost/projekt/users/users.php" role="button">Użytkownicy</a>
    <a style="text-align:center; margin-left:50px;" class="btn btn-primary" href="http://localhost/projekt/narzedzia/narzedzia.php" role="button">Narzędzia</a>
